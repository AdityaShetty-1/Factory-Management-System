...
Dashboard or cloud platform name

Exact threshold value used for alarm triggering

License
This project can be released under the MIT License or any license used by your organization.
